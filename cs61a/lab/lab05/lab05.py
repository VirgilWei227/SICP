...
def closer_city(lat, lon, city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    city_none = make_city('', lat, lon)
    return get_name(city_a) if distance(city_a, city_none) < distance(city_b, city_none) else get_name(city_b)
...
def berry_finder(t):
    ...
    if label(t) == 'berry':
        ...
        for branch in branches(t):
            value = value or berry_finder(branch)
        return value
