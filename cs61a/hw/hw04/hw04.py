...
def mul_interval(x, y):
    ...
    value in y."""
    return f_interval(x, y, mul)


def f_interval(x, y, f):
    p1 = f(lower_bound(x), lower_bound(y))
    p2 = f(lower_bound(x), upper_bound(y))
    p3 = f(upper_bound(x), lower_bound(y))
    p4 = f(upper_bound(x), upper_bound(y))
...
def check_par():
    ...
    True
    """
    r1 = interval(1000, 1001)  # Replace this line!
    r2 = interval(1000, 1002)  # Replace this line!
    return r1, r2
